...
from .forms import SentimentModelForm, SummarizationModelForm
from .models_lib.sentiment_analyzer import SentimentAnalyzer
from .models_lib.summarization_analyzer import SummarizationAnalyzer
...
def home(request):
    if request.method == 'GET':
        ...
        return render(request, 'index.html', {'sentimentForm': sentimentForm, 'summarizationForm': summarizationForm})
